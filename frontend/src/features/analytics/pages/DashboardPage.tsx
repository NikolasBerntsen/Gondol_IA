      ...
      {isNewShop ? (
        <Card padding="none">
          <EmptyState
            ...
            description="Empezá por traer tu catálogo desde un Excel o CSV, o cargá la primera mercadería con el escáner. En cuanto haya stock y ventas, acá vas a ver los vencimientos, la reposición y las recomendaciones de la IA."
            action={
              <div className="flex flex-col gap-2 sm:flex-row">
                <ButtonLink to="/app/imports" leftIcon={<Upload aria-hidden="true" />}>
                  Importar Excel o CSV
                </ButtonLink>
                <ButtonLink to="/app/intake" variant="outline">
                  Cargar mercadería
                </ButtonLink>
              </div>
            }
      ...
      <div className="grid grid-cols-1 gap-5 2xl:grid-cols-2">
        ...
        <Card id="reponer" tabIndex={-1} padding="none" className="scroll-mt-4 focus:outline-none">
          <CardHeader
            ...
            actions={
              <ButtonLink to="/app/inventory" size="sm" variant="ghost" rightIcon={<ArrowRight aria-hidden="true" />}>
                Ver inventario
              </ButtonLink>
            }
          />
