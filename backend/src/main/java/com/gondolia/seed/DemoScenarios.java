...
final class DemoScenarios {
    ...
    private static Scenario donPepe() {
        return new Scenario(
                ...
                List.of(new SupplyStop("PRI", "yerba", 9), new SupplyStop("PRI", "aceite", 6),
    ...
    private static Scenario elSol() {
        return new Scenario(
                ...
                List.of(new SupplyStop("CEN", "leche-desc", 4), new SupplyStop("FIS", "huevos", 5),
                        new SupplyStop("ECH", "agua", 6), new SupplyStop("FIS", LIVE_RECALL_PRODUCT, 25),
    ...
    private static Scenario vidaSana() {
        return new Scenario(
                ...
                List.of(new SupplyStop("NCB", "chia", 8), new SupplyStop("CDR", "avena", 7),
