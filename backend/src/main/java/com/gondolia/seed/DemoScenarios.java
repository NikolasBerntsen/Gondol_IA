...
final class DemoScenarios {
    ...
    private static Scenario donPepe() {
        return new Scenario(
                ...
                List.of(new SupplyStop("PRI", "yerba", 20), new SupplyStop("PRI", "aceite", 16),
    ...
    private static Scenario elSol() {
        return new Scenario(
                ...
                List.of(new SupplyStop("CEN", "leche-desc", 12), new SupplyStop("FIS", "huevos", 11),
                        new SupplyStop("CEN", "detergente", 19), new SupplyStop("FIS", "arroz", 19),
                        new SupplyStop("ECH", "cola", 13), new SupplyStop("CEN", "galletitas-dulces", 17),
                        new SupplyStop("ECH", "agua", 14), new SupplyStop("FIS", LIVE_RECALL_PRODUCT, 25),
    ...
    private static Scenario vidaSana() {
        return new Scenario(
                ...
                List.of(new SupplyStop("NCB", "chia", 20), new SupplyStop("CDR", "avena", 18),
